...
const LCD_CFG_t LCD_CFG = {
                            ...
                            .pins.Data[DataPin0].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin1].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin2].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin3].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin4].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin5].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin6].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin7].GPIO_Port = PORTA_GPIO,
                            .pins.Data[DataPin0].GPIO_Pin  = GPIO_PIN0 ,
                            .pins.Data[DataPin1].GPIO_Pin  = GPIO_PIN1 ,
                            .pins.Data[DataPin2].GPIO_Pin  = GPIO_PIN2 ,
                            .pins.Data[DataPin3].GPIO_Pin  = GPIO_PIN3 ,
                            .pins.Data[DataPin4].GPIO_Pin  = GPIO_PIN4 ,
                            .pins.Data[DataPin5].GPIO_Pin  = GPIO_PIN5 ,
                            .pins.Data[DataPin6].GPIO_Pin  = GPIO_PIN6 ,
                            .pins.Data[DataPin7].GPIO_Pin  = GPIO_PIN7
